...
function shuffleCardImageClasses() {
  ...
  let shuffleArray = _.shuffle(cardClasses);
...
function onCardFlipped(newlyFlippedCard) {
  ...
  const flipCounter = document.getElementById("flip-count");
  incrementCounter("flip-count", flipCounter);
  ...
  incrementCounter("match-count", matchCounter);
